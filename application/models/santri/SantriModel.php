...
class SantriModel extends Render_Model
{
    ...
    {
        $this->db->select('santri.id_santri, santri.nama, santri.tanggal_lahir, santri.jenis_kelamin, santri.tanggal, santri.alamat, santri.no_hp, santri.status, santri_ruang.nama as ruang, santri_tahun_ajaran.nama as tahun_ajaran, santri_tingkat.nama as tingkat, santri_kelas.nama as kelas');
        $this->db->from('santri');
