                            ...
                            <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-class="expand"><i class="fa fa-fw fa-phone text-muted hidden-md hidden-sm hidden-xs"></i> Tingkat</th>
                                        <th data-hide="phone"><i class="fa fa-fw fa-star-half-o text-muted hidden-md hidden-sm hidden-xs"></i> Ruang</th>
                                ...
                                <tbody>
                                    ...
                                    foreach ($records as $q) : ?>
                                        <tr data-id="<?= $q['id_santri'] ?>">
                                            ...
                                            <td>
                                                <div>
                                                    <button class="btn btn-warning btn-sm" onclick="Ubah()">
